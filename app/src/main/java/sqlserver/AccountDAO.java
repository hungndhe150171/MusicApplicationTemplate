...
public class AccountDAO extends DBContext {
    public Account getExistAccount(String username, String password) {
    ...
    public boolean changeActiveStatusByAccountId(String username, boolean active) {
        String sql = "\n" +
                "UPDATE [dbo].[ACCOUNT]\n" +
                "   SET [is_active] = ?\n" +
                " WHERE username = ?";
